...
if ( ! class_exists( 'ColorMag_SVG_Icons' ) ) {
	...
	class ColorMag_SVG_Icons {
		...
		public static $icons = array(
			...
			'drawer'           => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M2 8a1 1 0 011-1h18a1 1 0 110 2H3a1 1 0 01-1-1zm0 8a1 1 0 011-1h7a1 1 0 110 2H3a1 1 0 01-1-1zm1-5a1 1 0 100 2h13a1 1 0 100-2H3z" clip-rule="evenodd"/></svg>',
			'close-circle'     => '<svg xmlns="http://www.w3.org/2000/svg"><path d="M11.796 10.84a.66.66 0 010 .956.737.737 0 01-.478.204.737.737 0 01-.477-.204L6 6.955l-4.84 4.84A.737.737 0 01.681 12a.737.737 0 01-.477-.204.66.66 0 010-.955L5.045 6 .205 1.16a.66.66 0 010-.955.66.66 0 01.954 0L6 5.045l4.84-4.84a.66.66 0 01.956 0 .66.66 0 010 .954L6.955 6l4.84 4.84z" /></svg>',
		);
