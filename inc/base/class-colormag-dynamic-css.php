...
class ColorMag_Dynamic_CSS {
	...
	$parse_css .= colormag_parse_css( '#fff', $top_bar_background_color, $top_bar_background_color_css );
		...
		$drawer_background_color             = get_theme_mod( 'colormag_header_drawer_content_background', '' );
		$drawer_background_color_css = array(
			'.cm-drawer-box' => array(
				'background-color' => esc_html( $drawer_background_color ),
			),
		);
		$parse_css .= colormag_parse_css( '#fff', $drawer_background_color, $drawer_background_color_css );
