						...
						<div class="cm-dashboard-head-right" id="cm-dashboard-menu">
							<a class="colormag-title"
							   href="<?php echo esc_url('https://themegrill.com/themes/colormag/'); ?>" target="_blank">
								...
								<div>
									<a id="dashboard" href=<?php echo esc_url($admin_url . 'themes.php?page=colormag-dashboard&dashboard-page=dashboard'); ?>
									   target="_blank"><?php esc_html_e('Dashboard', 'colormag'); ?></a>
<!--									<a id="starter-templates" href="--><?php //echo esc_url(''); ?><!--"-->
