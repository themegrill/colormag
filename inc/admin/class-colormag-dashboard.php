...
class ColorMag_Dashboard {
	...
	public function option_page() {
		...
		$support_link ='https://wordpress.org/support/theme/colormag/';

		$pro_feature_links = array(
			__( 'Header Top Bar', 'colormag' )    => 'https://docs.colormagtheme.com/en/article/header-top-bar-overview-pro-40xyxb/',
		);
		?>
			<div class="wrap">
				<div class="metabox-holder">
					<div class="colormag-header" >
						<div class="colormag-container">
							<a class="colormag-title" href="<?php echo esc_url( 'https://colormagtheme.com/?utm_source=colormag-options-page&utm_medium=logo&utm_campaign=theme-info' ); ?>" target="_blank">
								<img class="colormag-icon" src="<?php echo esc_url( COLORMAG_PARENT_URL . '/inc/admin/images/colormag-logo.svg' ); ?>" alt="<?php esc_attr_e( 'ColorMag', 'colormag' ); ?>">
							...
							<div>
								<a href="<?php echo esc_url( 'https://colormagtheme.com/?utm_source=colormag-options-page&utm_medium=menu-link&utm_campaign=theme-info' ); ?>" target="_blank"><?php esc_html_e( 'Theme Info', 'colormag' ); ?></a>
								<a href="<?php echo esc_url( 'https://colormagtheme.com/demos/?utm_source=colormag-options-page&utm_medium=menu-link&utm_campaign=demos' ); ?>" target="_blank"><?php esc_html_e( 'Demos', 'colormag' ); ?></a>
								<a href="<?php echo esc_url( 'https://colormagtheme.com/pro/?utm_source=colormag-options-page&utm_medium=menu-link&utm_campaign=premium' ); ?>" target="_blank"><?php esc_html_e( 'Premium', 'colormag' ); ?></a>
								<a href="<?php echo esc_url( $support_link ); ?>" target="_blank"><?php esc_html_e( 'Support', 'colormag' ); ?></a>
								<a href="<?php echo esc_url( 'https://docs.colormagtheme.com/en/' ); ?>" target="_blank"><?php esc_html_e( 'Documentation', 'colormag' ); ?></a>
							</div>
						...
						<div class="postbox-container" style="float: none;">
							...
							<div class="col-30">
								<div class="postbox">
									...
									<a href="<?php echo esc_url( 'https://docs.colormagtheme.com/en/category/getting-started-1470csx/' ); ?>" target="_blank"><?php esc_html_e( 'Learn Basics &#129066;', 'colormag' ); ?></a>
								</div>
								<div class="postbox">
									...
									<div class="inside">
										<p>
											...
											echo sprintf(
												...
												$theme->Name,
												'<a href="' . esc_url( 'https://colormagtheme.com/demos/?utm_source=colormag-options-page&utm_medium=sidebar-link&utm_campaign=demos' ) . '" target="_blank">' . esc_html__( 'Demos.', 'colormag' ) . '</a>'
											);
											?>
										</p>
								...
								<div class="postbox">
									...
									<div class="inside">
										...
										<a href="<?php echo esc_url( 'https://www.facebook.com/groups/colormagtheme/' ); ?>" target="_blank"><?php esc_html_e( 'Join Now &#129066;', 'colormag' ); ?></a>
									</div>
								</div>
								<div class="postbox">
