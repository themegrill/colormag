				...
				<div class="welcome-panel-column-container">
					...
					<div class="welcome-panel-column">
						...
						<ul>
							...
							<li><?php printf( '<a target="_blank" href="%s" class="welcome-icon welcome-add-page">' . esc_html__( 'Premium Version', 'colormag' ) . '</a>', esc_url( 'http://themegrill.com/themes/colormag' ) ); ?></li>
						</ul>
					</div>
