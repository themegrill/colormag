...
$page_layout = array(
	...
	'right-sidebar'               => array(
		'id'    => 'colormag_page_layout',
		'value' => 'right_sidebar',
		'label' => esc_html__( 'Right Sidebar', 'colormag' ),
	),
	'left-sidebar'                => array(
		'id'    => 'colormag_page_layout',
		'value' => 'left_sidebar',
		'label' => esc_html__( 'Left Sidebar', 'colormag' ),
	),
	'no-sidebar-full-width'       => array(
		'id'    => 'colormag_page_layout',
		'value' => 'no_sidebar_full_width',
		'label' => esc_html__( 'No Sidebar Full Width', 'colormag' ),
	),
	'no-sidebar-content-centered' => array(
		'id'    => 'colormag_page_layout',
		'value' => 'no_sidebar_content_centered',
		'label' => esc_html__( 'No Sidebar Content Centered', 'colormag' ),
	),
);
...
function colormag_page_layout() {
	...
	foreach ( $page_layout as $field ) {
		...
		?>
		<input class="post-format" type="radio" name="<?php echo esc_html( $field['id'] ); ?>"
		       value="<?php echo esc_html( $field['value'] ); ?>" <?php checked( $field['value'], $layout_meta ); ?>
		/>
 ...
 *
 * @param int $post_id Post id of the current post edited.
 *
