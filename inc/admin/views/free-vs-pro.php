...
<div class="cm-container free-vs-pro-page">
	<div class="postbox-container" style="float: none;">
		...
		<div class="postbox">
			...
			<a  href="<?php echo esc_url( 'https://themegrill.com/pricing/?utm_medium=dash-free-vs-pro&utm_source=colormag-theme&utm_campaign=free-vs-pro&utm_content=get-pro-now' ); ?>" target="_blank"><span><?php esc_html_e( 'Get Pro Now', 'colormag' ); ?></span></a>
		</div>
	</div>
</div>
