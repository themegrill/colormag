...
$options = apply_filters(
	...
	array(
		...
		'colormag_site_identity_upgrade'         => array(
			...
			'url'         => esc_url( 'https://themegrill.com/themes/colormag-upgrade/?utm_source=cmag-free&utm_medium=upgrade-link&utm_campaign=ui-element-17' ),
			'section'     => 'title_tagline',
			'priority'    => 100,
		),
	)
...
do_action( 'colormag_customizer_site_identity_pro_options', $wp_customize );
