	...
	return array(
		...
		'desktop' => array_filter(
			array(
				...
				array(
					'name'     => colormag_get_registered_sidebar_name( 'colormag_footer_sidebar_one_upper', __( 'Widget 1', 'colormag' ) ),
					'section'  => 'colormag_footer_builder_widget_1',
					'section2' => 'sidebar-widgets-colormag_footer_sidebar_one_upper',
					'id'       => 'widget-1',
				),
				array(
					'name'     => colormag_get_registered_sidebar_name( 'colormag_footer_sidebar_two_upper', __( 'Widget 2', 'colormag' ) ),
					'section'  => 'colormag_footer_builder_widget_2',
					'section2' => 'sidebar-widgets-colormag_footer_sidebar_two_upper',
					'id'       => 'widget-2',
				),
				array(
					'name'     => colormag_get_registered_sidebar_name( 'colormag_footer_sidebar_three_upper', __( 'Widget 3', 'colormag' ) ),
					'section'  => 'colormag_footer_builder_widget_3',
					'section2' => 'sidebar-widgets-colormag_footer_sidebar_three_upper',
					'id'       => 'widget-3',
				),
				array(
					'name'     => colormag_get_registered_sidebar_name( 'colormag_footer_sidebar_one', __( 'Widget 4', 'colormag' ) ),
					'section'  => 'colormag_footer_builder_widget_4',
					'section2' => 'sidebar-widgets-colormag_footer_sidebar_one',
					'id'       => 'widget-4',
				),
				array(
					'name'     => colormag_get_registered_sidebar_name( 'colormag_footer_sidebar_two', __( 'Widget 5', 'colormag' ) ),
					'section'  => 'colormag_footer_builder_widget_5',
					'section2' => 'sidebar-widgets-colormag_footer_sidebar_two',
					'id'       => 'widget-5',
				),
				array(
					'name'     => colormag_get_registered_sidebar_name( 'colormag_footer_sidebar_three', __( 'Widget 6', 'colormag' ) ),
					'section'  => 'colormag_footer_builder_widget_6',
					'section2' => 'sidebar-widgets-colormag_footer_sidebar_three',
					'id'       => 'widget-6',
				),
				array(
					'name'     => colormag_get_registered_sidebar_name( 'colormag_footer_sidebar_four', __( 'Widget 7', 'colormag' ) ),
