...
colormagGenerateCSS( 'colormag_headings_color', 'h1, h2, h3, h4, h5, h6', 'color' )
colormagGenerateCSS( '$heading_h1_color', 'h1', 'color' )
colormagGenerateCSS( '$heading_h2_color', 'h2', 'color' )
colormagGenerateCSS( '$heading_h3_color', 'h3', 'color' )
...
colormagGenerateTypographyCSS( 'colormag_widget_title_typography', '.cm-secondary .widget-title, #tertiary .widget-title');
