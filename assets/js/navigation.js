...
( function() {
	const cmNavigation = function() {
		const self         = this;
		this.mobileMenu    = document.getElementById( 'cm-toggle-menu' );
		this.primaryMenu   = document.getElementById( 'cm-primary-nav' );
		this.toggleMenu    = document.getElementById( 'cm-mobile-nav' );
		this.toggleBtn     = this.mobileMenu ? this.mobileMenu.getElementsByClassName( 'cm-menu-toggle' )[0] : null;
